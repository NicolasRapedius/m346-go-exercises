...
func main() {
	...
	maria := Person{FullName{"Maria", "Curie"}, BirthDate{7, 11, 1867}}
	steve := Person{FullName{"Steve", "Jobs"}, BirthDate{24, 2, 1955}}
	nicolas := Person{FullName{"Nicolas", "Rapedius"}, BirthDate{24, 4, 2008}}
	...
	outputWithZodiacSign(maria)
	outputWithZodiacSign(steve)
	outputWithZodiacSign(nicolas)
}
